package com.tancfire.myplugintest;
...
public class AndroidLocalFile {
    ...
    public void deleteFileOnInternalStorage(Context contect, String filename){
        File file = new File(contect.getFilesDir(),filename);
        file.delete();
    }
